...
//                .role(userRequest.getRole())
//                .languagePreference(language)
//                .reputationScore(0) // 🔹 register වෙද්දී score 0
//                .verified(false)
//                .build();
//
//        userRepository.save(user);
...
//        }
//
//        // 🔹 login වෙද්දී reputation score +5
//        user.setReputationScore(user.getReputationScore() + 5);
//
//        // Update location if available
//        if(userRequest.getLatitude() != null && userRequest.getLongitude() != null){
//            user.setLatitude(userRequest.getLatitude());
...
public class UserServiceImpl implements UserService {
    ...
    public UserResponse register(UserRequest userRequest) throws UserNotCreatedException {
        ...
        // FIXED — wrap FCM call inside try-catch
    ...
    private UserResponse buildUserResponse(User user, String token) {
        ...
        return UserResponse.builder()
                ...
                .email(user.getEmail())
                .role(user.getRole())
                .languagePreference(user.getLanguagePreference() != null
